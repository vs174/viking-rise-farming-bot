    ...
    for find_button in array_find_button:
        ...
        if found_button is not None:
            ...
            # 자원 채집 버튼들
                ...
                found_button = pyautogui.locateOnScreen(find_button + ".png", confidence=0.9,
...
try:
    ...
    while True:
        ...
        if random.choice(['near','far']) == "near":
            ...
            cur_button = find_and_click_button(find_buttonsX)
        ...
        if same_button_cnt == 3:
            ...
            pyautogui.click(x=2, y=800, button='left', clicks=1, interval=0.1)   # 탈출
            pyautogui.scroll(100)
            prev_button = ""
            same_button_cnt = 0
